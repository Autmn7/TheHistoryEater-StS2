...
public class WipedFromHistory : KeineModCard
{
    ...
    {
        await DamageCmd.Attack(DynamicVars.CalculatedDamage).FromCard(this, cardPlay).Targeting(cardPlay.Target).WithHitFx("vfx/vfx_heavy_blunt", tmpSfx: "blunt_attack.mp3").Execute(choiceContext);
        if (InHuman())
